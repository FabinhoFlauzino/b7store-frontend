    ...
    <div className="bg-white border border-gray-200 px-7 mt-20">
      <div className={`flex items-center justify-between py-7 ${opened ? "border-b" : "border-0"} border-gray-200`}>
        ...
        <div
          ...
          className={`size-14 border border-gray-200 flex justify-center items-center rounded-sm`}>
          <Image
            src={'/assets/ui/arrow-left-s-line.png'}
            alt=""
            width={24}
            height={24}
            className={`inline-block cursor-pointer ${opened ? 'rotate-0' : 'rotate-180'} transition-all`}
          />
        </div>
