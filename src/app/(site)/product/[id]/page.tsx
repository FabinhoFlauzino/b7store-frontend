...
import { RelatedProductListSkeleton } from "@/components/product/related-products-skeleton"
  ...
  return (
    <div>
      <div className="text-gray-500 mb-4">
        <Link href="/">Home</Link> &gt; <Link href="/">TEMPORARIO</Link> &gt; Nome do produto
      </div>
      ...
      <ProductDescription text={data.product.description} />
       ...
       <Suspense fallback={<RelatedProductListSkeleton />}>
